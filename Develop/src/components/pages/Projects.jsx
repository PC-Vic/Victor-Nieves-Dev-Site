...
import passwordImage from '../../assets/computerCoding.jpg'
import weatherImage from '../../assets/sunnyweather.png'
...
const Projects = () => {
  ...
  const projectsData = [
    ...
    { id: 3, title: 'Weather Wizard', image: weatherImage, weatherWizardLink: 'https://pc-vic.github.io/Weather-Wizard/' },
    { id: 4, title: 'Pixel Market', image: pixelImage, pixelMarketLink: 'https://drive.google.com/file/d/1T938A97pL9xfBJQtZ0wezvkWoU9in8bF/view' },
    { id: 5, title: 'JavaScript Quiz', image: quizImage, quizLink: 'https://pc-vic.github.io/JavaScript-Quiz-app/' },
    { id: 6, title: 'Password Gen', image: passwordImage, passwordGenLink: 'https://pc-vic.github.io/Password-Gen/' },
